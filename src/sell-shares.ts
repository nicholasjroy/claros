 ...
 * Usage: npx tsx src/sell-shares.ts <market-address> <outcome-idx> <shares> [slippage-pct]
 *   slippage-pct defaults to 2 (2%)
 *
 * Example:
 *   npx tsx src/sell-shares.ts 0x94d829cce7e8532aef2a829489c1c1296c111990 0 5
 *   npx tsx src/sell-shares.ts 0x94d829cce7e8532aef2a829489c1c1296c111990 0 5 5
 */
...
if (!addr || !idxStr || !sharesStr) {
  console.error("Usage: npx tsx src/sell-shares.ts <market-address> <outcome-idx> <shares> [slippage-pct]");
  process.exit(1);
}
