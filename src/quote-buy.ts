 ...
 * Usage: npx tsx src/quote-buy.ts <market-address> <outcome-idx> <shares>
 *
 * Example:
 *   npx tsx src/quote-buy.ts 0x94d829cce7e8532aef2a829489c1c1296c111990 0 10
 */
import { client, toUsdc, sharesToBigint } from "./client.js";

const [, , addr, idxStr, sharesStr] = process.argv;
if (!addr || !idxStr || !sharesStr) {
  console.error("Usage: npx tsx src/quote-buy.ts <market-address> <outcome-idx> <shares>");
  process.exit(1);
}
